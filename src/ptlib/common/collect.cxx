 ...
 * $Revision: 32092 $
 * $Author: rjongbloed $
 * $Date: 2014-06-06 13:25:36 +0100 (Fri, 06 Jun 2014) $
 */
...
void PHashTableInfo::AppendElement(PObject * key, PObject * data PTRACE_PARAM(, PHashTable * owner))
{
  ...
  PTRACE_IF(1, list.m_size > 20 && list.m_size * 10 > totalSize / 8, owner, "PTLib",
            "Poor hash function used, more than 80% of " << totalSize <<
